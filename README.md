...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/iu5pjlkn/settings/api) and create a token with read rights.
